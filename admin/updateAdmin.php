...
<head>
    ...
    <title>Modification administrateur / <?php echo SITE_TITLE ?></title>
        ...
        <section class="text-center container">
            <div class="row py-sm-3 py-md-4 py-lg-5">
                <div class="col-lg-6 col-md-8 mx-auto">
                    ...
                    <form method="POST" action="functions/admins/update.php">
                    ...
                    <a id="11" class="text-white btn btn-danger tools" href="admins.php" title="Ce bouton vous permettra de revenir a la page précédente">
                        Annuler
                    </a>
                </div>
            </div>
