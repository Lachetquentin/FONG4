...
<body>
    ...
    $req = "SELECT * FROM products LIMIT 4";
    ...
    <div class="container pt-5 pb-5">
        <h3 class="text-center">Aperçu des produits</h3>
        <div class="row d-flex justify-content-center align-items-center">
            <?php foreach ($produits as $unProduit) : ?>
                <div class="col mt-3 d-flex justify-content-center">
                    <div class="card border-dark shadow-sm" style="width: 18rem;">
                        <div class="img p-2">
                            <img class="card-img-top rounded shadow" src="../static/images/produits/<?= $unProduit['picture'] ?>" alt="Card image cap" style="width:270px; height: 170px;">
                        </div>
                        <div class="card-body">
